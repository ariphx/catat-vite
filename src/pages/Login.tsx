...
// DI VITE: Pakai useNavigate dari react-router-dom
import { useNavigate } from "react-router-dom";
import { supabase } from "../lib/supabase"; // Pastikan path ke lib/supabase benar
import { motion, AnimatePresence } from "framer-motion";

export default function Login() {
  // DI VITE: Ganti useRouter() jadi useNavigate()
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (!isLoginMode) {
        ...
        if (error) throw error;
        // DI VITE: Ganti router.push jadi navigate
        navigate("/");
      }
    } catch (error: any) {
      setErrorMsg(
